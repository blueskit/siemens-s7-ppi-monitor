...
public class PpiCommunicationAnalyzingService
{
    public static PpiCommunicationAnalyzingService Instance { get; } = new PpiCommunicationAnalyzingService();
    ...
    public PpiBufferManager BufferHelper { get; private set; } = new PpiBufferManager();

    private Microsoft.Extensions.Logging.ILogger _logger;

    private PpiCommunicationAnalyzingService()
    {
        _serialPort = default;
        ...
        BufferHelper = new PpiBufferManager();
    }
